...
The `foolbox` package implements functionality for manipulating R functions by rewriting the components they consist of. The package provides various ways of rewriting functions using metaprogramming callbacks and how to combine such transformations.
